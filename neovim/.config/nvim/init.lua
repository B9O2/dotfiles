...
-- Route deprecation warnings to nvim-notify instead of blocking the command line
vim.deprecate = function(name, alternative, version, plugin, backtrace)
  -- 暂时屏蔽这些弹窗，直到找到更好的无声记录方案
end
...
-- Hide the command line until a command is typed
vim.o.cmdheight = 0
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('FileType', {
        callback = function()
          ...
          -- Prevent all code from being folded when opening a file
  ...
  -- Add nvim-notify for floating/bubble notifications
  --
  {
