...
pcall(function() vim.keymap.del("n", "H") end)
pcall(function() vim.keymap.del("n", "L") end)
pcall(function() vim.keymap.del("n", "<C-f>") end)
...
-- windows
map("n", "<leader>wh", function() vim.cmd("vertical resize -" .. (vim.v.count1 * 2)) end, { desc = "Decrease Window Width", remap = true })
map("n", "<leader>wj", function() vim.cmd("resize -" .. (vim.v.count1 * 2)) end, { desc = "Decrease Window Height", remap = true })
map("n", "<leader>wk", function() vim.cmd("resize +" .. (vim.v.count1 * 2)) end, { desc = "Increase Window Height", remap = true })
map("n", "<leader>wl", function() vim.cmd("vertical resize +" .. (vim.v.count1 * 2)) end, { desc = "Increase Window Width", remap = true })
